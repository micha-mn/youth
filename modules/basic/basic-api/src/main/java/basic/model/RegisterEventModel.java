...
/**
 * The base model interface for the RegisterEvent service. Represents a row in the &quot;RegisterEvent&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>basic.model.impl.RegisterEventModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>basic.model.impl.RegisterEventImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface RegisterEventModel
	extends BaseModel<RegisterEvent>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a register event model instance should use the {@link RegisterEvent} interface instead.
	 */
