...
/**
 * The base model interface for the EventHighLights service. Represents a row in the &quot;EventHighLights&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>basic.model.impl.EventHighLightsModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>basic.model.impl.EventHighLightsImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface EventHighLightsModel extends BaseModel<EventHighLights> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a event high lights model instance should use the {@link EventHighLights} interface instead.
	 */
