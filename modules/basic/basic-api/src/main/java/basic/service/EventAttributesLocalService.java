...
/**
 * Provides the local service interface for EventAttributes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EventAttributesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EventAttributesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventAttributesLocalServiceUtil} to access the event attributes local service. Add custom service methods to <code>basic.service.impl.EventAttributesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public EventAttributes addEventAttributes(EventAttributes eventAttributes);
	...
	public EventAttributes createEventAttributes(long id);
	...
	public EventAttributes deleteEventAttributes(
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public EventAttributes deleteEventAttributes(long id)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EventAttributes fetchEventAttributes(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EventAttributes getEventAttributes(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EventAttributes> getEventAttributeses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EventAttributes updateEventAttributes(
		EventAttributes eventAttributes);
