...
/**
 * Provides a wrapper for {@link EventAssigneeTableLocalService}.
 *
 ...
 */
@ProviderType
public class EventAssigneeTableLocalServiceWrapper
	implements EventAssigneeTableLocalService,
			   ServiceWrapper<EventAssigneeTableLocalService> {

	public EventAssigneeTableLocalServiceWrapper(
		EventAssigneeTableLocalService eventAssigneeTableLocalService) {

		_eventAssigneeTableLocalService = eventAssigneeTableLocalService;
	}
	 ...
	 */
	@Override
	public basic.model.EventAssigneeTable addEventAssigneeTable(
		basic.model.EventAssigneeTable eventAssigneeTable) {

		return _eventAssigneeTableLocalService.addEventAssigneeTable(
			eventAssigneeTable);
	}
	 ...
	 */
	@Override
	public basic.model.EventAssigneeTable createEventAssigneeTable(int Id) {
		return _eventAssigneeTableLocalService.createEventAssigneeTable(Id);
	}
	 ...
	 */
	@Override
	public basic.model.EventAssigneeTable deleteEventAssigneeTable(
		basic.model.EventAssigneeTable eventAssigneeTable) {

		return _eventAssigneeTableLocalService.deleteEventAssigneeTable(
			eventAssigneeTable);
	}
	 ...
	 */
	@Override
	public basic.model.EventAssigneeTable deleteEventAssigneeTable(int Id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _eventAssigneeTableLocalService.deleteEventAssigneeTable(Id);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _eventAssigneeTableLocalService.deletePersistedModel(
			persistedModel);
	}

	@Override
	public com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery() {
		return _eventAssigneeTableLocalService.dynamicQuery();
	}
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _eventAssigneeTableLocalService.dynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return _eventAssigneeTableLocalService.dynamicQueryCount(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return _eventAssigneeTableLocalService.dynamicQueryCount(
			dynamicQuery, projection);
	}

	@Override
	public basic.model.EventAssigneeTable fetchEventAssigneeTable(int Id) {
		return _eventAssigneeTableLocalService.fetchEventAssigneeTable(Id);
	}
	 ...
	 */
	@Override
	public basic.model.EventAssigneeTable
		fetchEventAssigneeTableByUuidAndGroupId(String uuid, long groupId) {

		return _eventAssigneeTableLocalService.
			fetchEventAssigneeTableByUuidAndGroupId(uuid, groupId);
	}
	...
	public com.liferay.portal.kernel.dao.orm.ActionableDynamicQuery
		...
		return _eventAssigneeTableLocalService.getActionableDynamicQuery();
	}
	 ...
	 */
	@Override
	public basic.model.EventAssigneeTable getEventAssigneeTable(int Id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _eventAssigneeTableLocalService.getEventAssigneeTable(Id);
	}
	 ...
	 */
	@Override
	public basic.model.EventAssigneeTable getEventAssigneeTableByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _eventAssigneeTableLocalService.
			getEventAssigneeTableByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	@Override
	public java.util.List<basic.model.EventAssigneeTable>
		getEventAssigneeTables(int start, int end) {

		return _eventAssigneeTableLocalService.getEventAssigneeTables(
			start, end);
	}
	...
	public java.util.List<basic.model.EventAssigneeTable>
		...
		return _eventAssigneeTableLocalService.
			getEventAssigneeTablesByUuidAndCompanyId(uuid, companyId);
	}
	...
	public int getEventAssigneeTablesCount() {
		return _eventAssigneeTableLocalService.getEventAssigneeTablesCount();
	}
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _eventAssigneeTableLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
	...
	public String getOSGiServiceIdentifier() {
		return _eventAssigneeTableLocalService.getOSGiServiceIdentifier();
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel getPersistedModel(
		...
		return _eventAssigneeTableLocalService.getPersistedModel(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public basic.model.EventAssigneeTable updateEventAssigneeTable(
		basic.model.EventAssigneeTable eventAssigneeTable) {

		return _eventAssigneeTableLocalService.updateEventAssigneeTable(
			eventAssigneeTable);
	}

	@Override
	public EventAssigneeTableLocalService getWrappedService() {
		return _eventAssigneeTableLocalService;
	}
	...
	private EventAssigneeTableLocalService _eventAssigneeTableLocalService;
