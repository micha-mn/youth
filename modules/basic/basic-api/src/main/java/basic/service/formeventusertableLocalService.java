...
/**
 * Provides the local service interface for formeventusertable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see formeventusertableLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface formeventusertableLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link formeventusertableLocalServiceUtil} to access the formeventusertable local service. Add custom service methods to <code>basic.service.impl.formeventusertableLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public formeventusertable addformeventusertable(
	...
	public formeventusertable createformeventusertable(long ID);
	...
	public formeventusertable deleteformeventusertable(
		formeventusertable formeventusertable);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public formeventusertable deleteformeventusertable(long ID)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public formeventusertable fetchformeventusertable(long ID);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public formeventusertable getformeventusertable(long ID)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<formeventusertable> getformeventusertables(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public formeventusertable updateformeventusertable(
		formeventusertable formeventusertable);
