...
/**
 * Provides the local service interface for EventSpeakers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EventSpeakersLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EventSpeakersLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventSpeakersLocalServiceUtil} to access the event speakers local service. Add custom service methods to <code>basic.service.impl.EventSpeakersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
