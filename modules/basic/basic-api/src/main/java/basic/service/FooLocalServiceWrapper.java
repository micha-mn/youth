...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public basic.model.Foo addFoo(basic.model.Foo foo) {
	 ...
	 */
	@Override
	public basic.model.Foo createFoo(long fooId) {
	 ...
	 */
	@Override
	public basic.model.Foo deleteFoo(basic.model.Foo foo) {
	 ...
	 */
	@Override
	public basic.model.Foo deleteFoo(long fooId)
	...
	@Override
	public basic.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	@Override
	public basic.model.Foo fetchFooByUuidAndGroupId(String uuid, long groupId) {
	 ...
	 */
	@Override
	public basic.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public basic.model.Foo getFooByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<basic.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<basic.model.Foo> getFoosByUuidAndCompanyId(
	 ...
	 */
	@Override
	public basic.model.Foo updateFoo(basic.model.Foo foo) {
