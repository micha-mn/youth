...
/**
 * Provides the local service interface for ImageCalendar. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ImageCalendarLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ImageCalendarLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ImageCalendarLocalServiceUtil} to access the image calendar local service. Add custom service methods to <code>basic.service.impl.ImageCalendarLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ImageCalendarDataBlobModel getDataBlobModel(Serializable primaryKey);
