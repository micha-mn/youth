...
/**
 * Provides the local service interface for ProfileJobWishList. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProfileJobWishListLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProfileJobWishListLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProfileJobWishListLocalServiceUtil} to access the profile job wish list local service. Add custom service methods to <code>basic.service.impl.ProfileJobWishListLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
