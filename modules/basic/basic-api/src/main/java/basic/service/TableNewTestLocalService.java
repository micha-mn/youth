...
/**
 * Provides the local service interface for TableNewTest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TableNewTestLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TableNewTestLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TableNewTestLocalServiceUtil} to access the table new test local service. Add custom service methods to <code>basic.service.impl.TableNewTestLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
