...
/**
 * Provides the local service interface for Journey. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JourneyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JourneyLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JourneyLocalServiceUtil} to access the journey local service. Add custom service methods to <code>basic.service.impl.JourneyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Journey createJourney(long journeyId);
	...
	public Journey deleteJourney(Journey journey);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Journey deleteJourney(long journeyId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Journey fetchJourney(long journeyId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Journey> getJourneies(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Journey getJourney(long journeyId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JourneyPictureBlobBlobModel getPictureBlobBlobModel(
