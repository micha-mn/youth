 ...
 * <code>basic.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>basic.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static basic.model.Foo addFoo(basic.model.Foo foo) {
	 ...
	 * @return the new foo
	 */
	public static basic.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static basic.model.Foo deleteFoo(basic.model.Foo foo) {
	 ...
	 */
	public static basic.model.Foo deleteFoo(long fooId)
	...
	public static basic.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static basic.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static basic.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static basic.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<basic.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	public static java.util.List<basic.model.Foo> getFoosByUuidAndCompanyId(
	...
	public static java.util.List<basic.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<basic.model.Foo>
			orderByComparator) {
	 ...
	 */
	public static basic.model.Foo updateFoo(basic.model.Foo foo) {
