...
/**
 * Provides the local service interface for EventFAQs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EventFAQsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EventFAQsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventFAQsLocalServiceUtil} to access the event fa qs local service. Add custom service methods to <code>basic.service.impl.EventFAQsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
