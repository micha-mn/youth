...
/**
 * Provides the local service interface for EventHighLights. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EventHighLightsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EventHighLightsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventHighLightsLocalServiceUtil} to access the event high lights local service. Add custom service methods to <code>basic.service.impl.EventHighLightsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
