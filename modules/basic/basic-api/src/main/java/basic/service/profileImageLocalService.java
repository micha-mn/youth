...
/**
 * Provides the local service interface for profileImage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see profileImageLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface profileImageLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link profileImageLocalServiceUtil} to access the profile image local service. Add custom service methods to <code>basic.service.impl.profileImageLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public profileImage createprofileImage(long id);
	...
	public profileImage deleteprofileImage(long id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public profileImage deleteprofileImage(profileImage profileImage);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public profileImage fetchprofileImage(long id);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public profileImageImageBlobModel getImageBlobModel(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public profileImage getprofileImage(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<profileImage> getprofileImages(int start, int end);
