...
/**
 * Provides the local service interface for RegisterEvent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RegisterEventLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RegisterEventLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RegisterEventLocalServiceUtil} to access the register event local service. Add custom service methods to <code>basic.service.impl.RegisterEventLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
