...
/**
 * Provides the local service interface for EventTimeline. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EventTimelineLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EventTimelineLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventTimelineLocalServiceUtil} to access the event timeline local service. Add custom service methods to <code>basic.service.impl.EventTimelineLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
