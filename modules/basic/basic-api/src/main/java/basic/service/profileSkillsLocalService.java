...
/**
 * Provides the local service interface for profileSkills. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see profileSkillsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface profileSkillsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link profileSkillsLocalServiceUtil} to access the profile skills local service. Add custom service methods to <code>basic.service.impl.profileSkillsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
