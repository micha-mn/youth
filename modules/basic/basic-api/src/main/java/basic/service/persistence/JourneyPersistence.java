...
/**
 * The persistence interface for the journey service.
 *
 * <p>
 ...
 */
@ProviderType
public interface JourneyPersistence extends BasePersistence<Journey> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JourneyUtil} to access the journey persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<Journey> journeies);
	 ...
	 */
	public java.util.List<Journey> findAll();
	 ...
	 */
	public java.util.List<Journey> findAll(int start, int end);
