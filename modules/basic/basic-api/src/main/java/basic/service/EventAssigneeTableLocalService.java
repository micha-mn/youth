...
/**
 * Provides the local service interface for EventAssigneeTable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EventAssigneeTableLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EventAssigneeTableLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventAssigneeTableLocalServiceUtil} to access the event assignee table local service. Add custom service methods to <code>basic.service.impl.EventAssigneeTableLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
