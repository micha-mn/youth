...
import basic.service.EventTimelineService;
...
/**
 * Provides the base implementation for the event timeline remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.EventTimelineServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.EventTimelineServiceImpl
 * @generated
 */
public abstract class EventTimelineServiceBaseImpl
	extends BaseServiceImpl
	implements EventTimelineService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EventTimelineService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.EventTimelineServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EventTimelineService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		eventTimelineService = (EventTimelineService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EventTimelineService.class.getName();
	}
	...
	@Reference
	protected basic.service.EventTimelineLocalService eventTimelineLocalService;

	protected EventTimelineService eventTimelineService;
