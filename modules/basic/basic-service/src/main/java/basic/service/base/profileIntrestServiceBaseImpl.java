...
import basic.service.profileIntrestService;
...
/**
 * Provides the base implementation for the profile intrest remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.profileIntrestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.profileIntrestServiceImpl
 * @generated
 */
public abstract class profileIntrestServiceBaseImpl
	extends BaseServiceImpl
	implements profileIntrestService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>profileIntrestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.profileIntrestServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			profileIntrestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		profileIntrestService = (profileIntrestService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return profileIntrestService.class.getName();
	}
	...
	@Reference
	protected basic.service.profileIntrestLocalService
		profileIntrestLocalService;

	protected profileIntrestService profileIntrestService;
