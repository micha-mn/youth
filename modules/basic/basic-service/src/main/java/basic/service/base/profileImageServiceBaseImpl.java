...
import basic.service.profileImageService;
...
/**
 * Provides the base implementation for the profile image remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.profileImageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.profileImageServiceImpl
 * @generated
 */
public abstract class profileImageServiceBaseImpl
	extends BaseServiceImpl
	implements profileImageService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>profileImageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.profileImageServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			profileImageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		profileImageService = (profileImageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return profileImageService.class.getName();
	}
	...
	@Reference
	protected basic.service.profileImageLocalService profileImageLocalService;
