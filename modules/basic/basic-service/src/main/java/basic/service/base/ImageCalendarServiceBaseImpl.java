...
import basic.service.ImageCalendarService;
...
/**
 * Provides the base implementation for the image calendar remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.ImageCalendarServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.ImageCalendarServiceImpl
 * @generated
 */
public abstract class ImageCalendarServiceBaseImpl
	extends BaseServiceImpl
	implements ImageCalendarService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ImageCalendarService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.ImageCalendarServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ImageCalendarService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		imageCalendarService = (ImageCalendarService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ImageCalendarService.class.getName();
	}
	...
	@Reference
	protected basic.service.ImageCalendarLocalService imageCalendarLocalService;

	protected ImageCalendarService imageCalendarService;
