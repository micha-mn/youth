...
import basic.service.EventAttributesLocalService;
...
/**
 * Provides the base implementation for the event attributes local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.EventAttributesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.EventAttributesLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class EventAttributesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements EventAttributesLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EventAttributesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.EventAttributesLocalServiceUtil</code>.
	 */
	...
	public EventAttributes addEventAttributes(EventAttributes eventAttributes) {
		...
		return eventAttributesPersistence.update(eventAttributes);
	}
	...
	public EventAttributes createEventAttributes(long id) {
		return eventAttributesPersistence.create(id);
	}
	...
	public EventAttributes deleteEventAttributes(long id)
		...
		return eventAttributesPersistence.remove(id);
	}
	...
	public EventAttributes deleteEventAttributes(
		...
		return eventAttributesPersistence.remove(eventAttributes);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EventAttributes.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return eventAttributesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return eventAttributesPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return eventAttributesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return eventAttributesPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EventAttributes fetchEventAttributes(long id) {
		return eventAttributesPersistence.fetchByPrimaryKey(id);
	}
	...
	public EventAttributes getEventAttributes(long id) throws PortalException {
		return eventAttributesPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(eventAttributesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EventAttributes.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EventAttributes.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return eventAttributesLocalService.deleteEventAttributes(
			(EventAttributes)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return eventAttributesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EventAttributes> getEventAttributeses(int start, int end) {
		return eventAttributesPersistence.findAll(start, end);
	}
	...
	public int getEventAttributesesCount() {
		return eventAttributesPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EventAttributesLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		eventAttributesLocalService = (EventAttributesLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EventAttributesLocalService.class.getName();
	}
	...
	protected EventAttributesLocalService eventAttributesLocalService;
