...
import basic.service.EventHighLightsService;
...
/**
 * Provides the base implementation for the event high lights remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.EventHighLightsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.EventHighLightsServiceImpl
 * @generated
 */
public abstract class EventHighLightsServiceBaseImpl
	extends BaseServiceImpl
	implements EventHighLightsService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EventHighLightsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.EventHighLightsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EventHighLightsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		eventHighLightsService = (EventHighLightsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EventHighLightsService.class.getName();
	}
	...
	@Reference
	protected basic.service.EventHighLightsLocalService
		eventHighLightsLocalService;

	protected EventHighLightsService eventHighLightsService;
