...
import basic.service.profileSkillsService;
...
/**
 * Provides the base implementation for the profile skills remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.profileSkillsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.profileSkillsServiceImpl
 * @generated
 */
public abstract class profileSkillsServiceBaseImpl
	extends BaseServiceImpl
	implements profileSkillsService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>profileSkillsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.profileSkillsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			profileSkillsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		profileSkillsService = (profileSkillsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return profileSkillsService.class.getName();
	}
	...
	@Reference
	protected basic.service.profileSkillsLocalService profileSkillsLocalService;

	protected profileSkillsService profileSkillsService;
