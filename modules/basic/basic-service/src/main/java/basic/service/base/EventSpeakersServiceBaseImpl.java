...
import basic.service.EventSpeakersService;
...
/**
 * Provides the base implementation for the event speakers remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.EventSpeakersServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.EventSpeakersServiceImpl
 * @generated
 */
public abstract class EventSpeakersServiceBaseImpl
	extends BaseServiceImpl
	implements EventSpeakersService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EventSpeakersService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.EventSpeakersServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EventSpeakersService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		eventSpeakersService = (EventSpeakersService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EventSpeakersService.class.getName();
	}
	...
	@Reference
	protected basic.service.EventSpeakersLocalService eventSpeakersLocalService;

	protected EventSpeakersService eventSpeakersService;
