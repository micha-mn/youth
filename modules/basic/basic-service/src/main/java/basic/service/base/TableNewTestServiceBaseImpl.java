...
import basic.service.TableNewTestService;
...
/**
 * Provides the base implementation for the table new test remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.TableNewTestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.TableNewTestServiceImpl
 * @generated
 */
public abstract class TableNewTestServiceBaseImpl
	extends BaseServiceImpl
	implements TableNewTestService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TableNewTestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.TableNewTestServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TableNewTestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		tableNewTestService = (TableNewTestService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TableNewTestService.class.getName();
	}
	...
	@Reference
	protected basic.service.TableNewTestLocalService tableNewTestLocalService;

	protected TableNewTestService tableNewTestService;
