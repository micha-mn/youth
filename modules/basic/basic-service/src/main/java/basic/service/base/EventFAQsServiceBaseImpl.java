...
import basic.service.EventFAQsService;
...
/**
 * Provides the base implementation for the event fa qs remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.EventFAQsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.EventFAQsServiceImpl
 * @generated
 */
public abstract class EventFAQsServiceBaseImpl
	extends BaseServiceImpl
	implements EventFAQsService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EventFAQsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.EventFAQsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EventFAQsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		eventFAQsService = (EventFAQsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EventFAQsService.class.getName();
	}
	...
	@Reference
	protected basic.service.EventFAQsLocalService eventFAQsLocalService;

	protected EventFAQsService eventFAQsService;
