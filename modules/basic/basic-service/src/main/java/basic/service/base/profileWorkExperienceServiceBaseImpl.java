...
import basic.service.profileWorkExperienceService;
...
/**
 * Provides the base implementation for the profile work experience remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.profileWorkExperienceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.profileWorkExperienceServiceImpl
 * @generated
 */
public abstract class profileWorkExperienceServiceBaseImpl
	extends BaseServiceImpl
	implements profileWorkExperienceService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>profileWorkExperienceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.profileWorkExperienceServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			profileWorkExperienceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		profileWorkExperienceService = (profileWorkExperienceService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return profileWorkExperienceService.class.getName();
	}
	...
	@Reference
	protected basic.service.profileWorkExperienceLocalService
		profileWorkExperienceLocalService;

	protected profileWorkExperienceService profileWorkExperienceService;
