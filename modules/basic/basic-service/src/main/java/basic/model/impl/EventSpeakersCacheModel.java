...
public class EventSpeakersCacheModel
	...
	public EventSpeakers toEntityModel() {
		...
		if (isNotifEnabled == null) {
			eventSpeakersImpl.setIsNotifEnabled("");
		}
		else {
			eventSpeakersImpl.setIsNotifEnabled(isNotifEnabled);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		isNotifEnabled = objectInput.readUTF();
	}
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		if (isNotifEnabled == null) {
			...
			objectOutput.writeUTF(isNotifEnabled);
		}
	}
