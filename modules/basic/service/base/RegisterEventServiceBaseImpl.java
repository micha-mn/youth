...
import basic.service.RegisterEventService;
...
/**
 * Provides the base implementation for the register event remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.RegisterEventServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.RegisterEventServiceImpl
 * @generated
 */
public abstract class RegisterEventServiceBaseImpl
	extends BaseServiceImpl
	implements RegisterEventService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RegisterEventService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.RegisterEventServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RegisterEventService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		registerEventService = (RegisterEventService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RegisterEventService.class.getName();
	}
	...
	@Reference
	protected basic.service.RegisterEventLocalService registerEventLocalService;
