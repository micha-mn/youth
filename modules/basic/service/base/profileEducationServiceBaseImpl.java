...
import basic.service.profileEducationService;
...
/**
 * Provides the base implementation for the profile education remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.profileEducationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.profileEducationServiceImpl
 * @generated
 */
public abstract class profileEducationServiceBaseImpl
	extends BaseServiceImpl
	implements profileEducationService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>profileEducationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.profileEducationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			profileEducationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		profileEducationService = (profileEducationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return profileEducationService.class.getName();
	}
	...
	@Reference
	protected basic.service.profileEducationLocalService
		profileEducationLocalService;

	protected profileEducationService profileEducationService;
