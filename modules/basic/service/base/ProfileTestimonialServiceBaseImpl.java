...
import basic.service.ProfileTestimonialService;
...
/**
 * Provides the base implementation for the profile testimonial remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.ProfileTestimonialServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.ProfileTestimonialServiceImpl
 * @generated
 */
public abstract class ProfileTestimonialServiceBaseImpl
	extends BaseServiceImpl
	implements ProfileTestimonialService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProfileTestimonialService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.ProfileTestimonialServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProfileTestimonialService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		profileTestimonialService = (ProfileTestimonialService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProfileTestimonialService.class.getName();
	}
	...
	@Reference
	protected basic.service.ProfileTestimonialLocalService
		profileTestimonialLocalService;

	protected ProfileTestimonialService profileTestimonialService;
