...
import basic.service.JourneyLocalService;
...
/**
 * Provides the base implementation for the journey local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.JourneyLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.JourneyLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class JourneyLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements JourneyLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JourneyLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.JourneyLocalServiceUtil</code>.
	 */
	...
	public Journey addJourney(Journey journey) {
		...
		return journeyPersistence.update(journey);
	}
	...
	public Journey createJourney(long journeyId) {
		return journeyPersistence.create(journeyId);
	}
	...
	public Journey deleteJourney(long journeyId) throws PortalException {
		return journeyPersistence.remove(journeyId);
	}
	...
	public Journey deleteJourney(Journey journey) {
		return journeyPersistence.remove(journey);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Journey.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return journeyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return journeyPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return journeyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return journeyPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Journey fetchJourney(long journeyId) {
		return journeyPersistence.fetchByPrimaryKey(journeyId);
	}
	...
	public Journey getJourney(long journeyId) throws PortalException {
		return journeyPersistence.findByPrimaryKey(journeyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(journeyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Journey.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("journeyId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Journey.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("journeyId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return journeyLocalService.deleteJourney((Journey)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return journeyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Journey> getJourneies(int start, int end) {
		return journeyPersistence.findAll(start, end);
	}
	...
	public int getJourneiesCount() {
		return journeyPersistence.countAll();
	}
	...
	public JourneyPictureBlobBlobModel getPictureBlobBlobModel(
		...
		try {
			session = journeyPersistence.openSession();

			return (JourneyPictureBlobBlobModel)session.get(
				JourneyPictureBlobBlobModel.class, primaryKey);
		}
		catch (Exception e) {
			throw journeyPersistence.processException(e);
		}
		finally {
			journeyPersistence.closeSession(session);
		}
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JourneyLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		journeyLocalService = (JourneyLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JourneyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = journeyPersistence.getDataSource();
	...
	protected JourneyLocalService journeyLocalService;
