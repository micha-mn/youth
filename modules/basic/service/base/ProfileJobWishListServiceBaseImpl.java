...
import basic.service.ProfileJobWishListService;
...
/**
 * Provides the base implementation for the profile job wish list remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.ProfileJobWishListServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.ProfileJobWishListServiceImpl
 * @generated
 */
public abstract class ProfileJobWishListServiceBaseImpl
	extends BaseServiceImpl
	implements ProfileJobWishListService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProfileJobWishListService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.ProfileJobWishListServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProfileJobWishListService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		profileJobWishListService = (ProfileJobWishListService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProfileJobWishListService.class.getName();
	}
	...
	@Reference
	protected basic.service.ProfileJobWishListLocalService
		profileJobWishListLocalService;

	protected ProfileJobWishListService profileJobWishListService;
