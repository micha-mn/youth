...
import basic.service.profileImageLocalService;
...
/**
 * Provides the base implementation for the profile image local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.profileImageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.profileImageLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class profileImageLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements profileImageLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>profileImageLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.profileImageLocalServiceUtil</code>.
	 */
	...
	public profileImage addprofileImage(profileImage profileImage) {
		...
		return profileImagePersistence.update(profileImage);
	}
	...
	public profileImage createprofileImage(long id) {
		return profileImagePersistence.create(id);
	}
	...
	public profileImage deleteprofileImage(long id) throws PortalException {
		return profileImagePersistence.remove(id);
	}
	...
	public profileImage deleteprofileImage(profileImage profileImage) {
		return profileImagePersistence.remove(profileImage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			profileImage.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return profileImagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return profileImagePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return profileImagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return profileImagePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public profileImage fetchprofileImage(long id) {
		return profileImagePersistence.fetchByPrimaryKey(id);
	}
	...
	public profileImage getprofileImage(long id) throws PortalException {
		return profileImagePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(profileImageLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(profileImage.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			profileImageLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(profileImage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return profileImageLocalService.deleteprofileImage(
			(profileImage)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return profileImagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<profileImage> getprofileImages(int start, int end) {
		return profileImagePersistence.findAll(start, end);
	}
	...
	public int getprofileImagesCount() {
		return profileImagePersistence.countAll();
	}
	...
	public profileImageImageBlobModel getImageBlobModel(
		...
		try {
			session = profileImagePersistence.openSession();

			return (profileImageImageBlobModel)session.get(
				profileImageImageBlobModel.class, primaryKey);
		}
		catch (Exception e) {
			throw profileImagePersistence.processException(e);
		}
		finally {
			profileImagePersistence.closeSession(session);
		}
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			profileImageLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		profileImageLocalService = (profileImageLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return profileImageLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = profileImagePersistence.getDataSource();
	...
	protected profileImageLocalService profileImageLocalService;
