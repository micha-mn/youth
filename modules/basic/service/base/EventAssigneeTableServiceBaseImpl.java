...
import basic.service.EventAssigneeTableService;
...
/**
 * Provides the base implementation for the event assignee table remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link basic.service.impl.EventAssigneeTableServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see basic.service.impl.EventAssigneeTableServiceImpl
 * @generated
 */
public abstract class EventAssigneeTableServiceBaseImpl
	extends BaseServiceImpl
	implements EventAssigneeTableService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EventAssigneeTableService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>basic.service.EventAssigneeTableServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EventAssigneeTableService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		eventAssigneeTableService = (EventAssigneeTableService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EventAssigneeTableService.class.getName();
	}
	...
	@Reference
	protected basic.service.EventAssigneeTableLocalService
		eventAssigneeTableLocalService;

	protected EventAssigneeTableService eventAssigneeTableService;
