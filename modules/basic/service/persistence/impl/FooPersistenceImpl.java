...
import basic.exception.NoSuchFooException;

import basic.model.Foo;
import basic.model.impl.FooImpl;
import basic.model.impl.FooModelImpl;
...
public class FooPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.basic.model.Foo"),
			true);
	}
