...
<%
			...
			String mainIntroContent  = mainIntroDocumentJournalArticle.getContent();
			...
			// aboutUsAndMission
			 ...
			 String aboutUsAndMissionContent  = aboutUsAndMissionJournalArticle.getContent();
			 ...
			 System.out.println("777777");
			 			...
			 			for (int i=1; i <5;i++){
			 				 ...
			 				 String websitebenefitsContent  = websitebenefitsJournalArticle.getContent();
			 ...
			 String dynamicnumberstructureContent  = dynamicnumberstructureJournalArticle.getContent();
			 ...
			 String ImproveattitudeofYouth = number3Node.getText();
					 ...
					 String upcommingevent_1Content  = upcommingevent_1JournalArticle.getContent();
		 ...
		 String upcommingevent_2Content  = upcommingevent_2JournalArticle.getContent();
		...
		String upcommingevent_3Content  = upcommingevent_3JournalArticle.getContent();
 	...
 	if(i==3)
 	{
		...
		href3 = "'"+event.getExpandoBridge().getAttribute("Location link").toString()+"'";
 	 	...
 	 	if(i==4)
 	 	{
 			...
 			img4 = evt.getImageBybookingEvent(event3.getCalendarBookingId());
    ...
    height: 100%;
	 ...
	 color: #042f3f;
      ...
      .news-title{
		...
		.register-button-scroll {margin:8px 15px !important}
		...
		a.join-button {position:relative; top:15px !important; margin-right: 2%;}
...
.carousel-indicators .active {
  ...
  ::-webkit-input-placeholder { /* Edge */
	...
	.btn-singin{
		...
		.menu-nav span{text-transform:capitalize;}
          ...
          <div class="container" id="intro">
              <div class="row" id="banner-col1">
					<div class="col-xl-7">
						...
						<a href="#" class="btnn btn-discvr">Discover More</a>
						<a href="#" class="btnn btn-discvr">Register More</a>
					</div>
					<div class="col-xl-5">
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-12 col-12">
						<h2>How it Works</h2>
						<p>More than 3,000 participants from business, government, media and civil society will join an intense one-day program to:</p>
					</div>
				</div>
				<div class="row">
					<div class="col-xl-5 txt-sec col-12 col-md-5">
						<div class="regstr-sec2">
							...
							<p>It is said that an average adult makes 35,000 conscious decisions per day.</p>
							<a href="#" class="btnn">Register Now</a>
						</div>
					</div>
						...
						<div class="rgstr-farm">
							...
							<div class="forrm">
								...
								<fieldset>
									...
									<a href="/web/guest/home?p_p_id=com_liferay_login_web_portlet_LoginPortlet&p_p_lifecycle=0&p_p_state=maximized&p_p_mode=view&saveLastPath=false&_com_liferay_login_web_portlet_LoginPortlet_mvcRenderCommandName=%2Flogin%2Fcreate_account"  id="synup" class="synup">Sign up</a>
									</fieldset>
				...
				<div class="row">
					...
					<div class="col-xl-5 txt-sec col-12 col-md-5">
						<div class="regstr-sec2">
							...
							<p>Join forces with your peers to inspire you while accessing a wider network of youth organisations, businesses, experts and educators to support your journey.</p>
							<a href="#" class="btnn">Register Now</a>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-xl-5 txt-sec col-12 col-md-5">
						<div class="regstr-sec2">
							...
							<p>Young people must be provided with the right tools and information in order to grow into leaders and builders of tomorrow – “The Architects of the Future” </p>
							<a href="#" class="btnn">Register Now</a>
						</div>
					</div>
					<div class="col-xl-7 col-12 col-md-7">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-4 countr-2 col-md-4">
						...
						<p class="typ">Monthly Active <br>Members</p>
						</div>
					</div>
					<div class="col-xl-4 col-md-4">
						<div class="countar">
						<h4 class="numbr"><%=ImproveattitudeofYouth%></h4>
						<p class="typ">Improve attitude <br>of Youth</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-xl-12 col-12 col-md-12">
						<video width="100%" height="600px" controls>
 							 <source src="/o/new-misk-theme/landingPage/video/dummy-video.mp4" type="video/mp4">
 							 <source src="/o/new-misk-theme/landingPage/mov_bbb.ogg" type="video/ogg">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xl-6 col-12 col-md-12 col-lg-6 m-ipad">
						<div class="eventt">
							<div class="evnt-img">
								<img src=<%=img1%> style="height: 223px;">
							</div>
							<div class="evnt-txt">
								<span class="date-tym"><%=mYear1%>-<%=mMonthF1%>-<%=mDayFS1%> <%=hrF1%>:<%=minF1%></span>
										<a href="${renderAction1}&<portlet:namespace />calendarBookingId=<%=calendarBookingId1%>">
										<h4><%=titleEvent1%></h4></a>										
									<p>	<span class="location location-link">
										...
										<a  onclick="openQuestioneer(<%=href1%>)"><%=location1%></a></span></p>
								<p class="event1-description"><%=descriptionEvent1%></p>								
							</div>
					...
					<div class="col-xl-6 col-12 col-md-12 col-lg-6 m-ipad">
						<div class="eventt">
							<div class="evnt-img">
								<img src=<%=img2%> style="height: 223px;">
							</div>
							<div class="evnt-txt">
								<span class="date-tym"><%=mYear2%>-<%=mMonthF2%>-<%=mDayFS2%> <%=hrF2%>:<%=minF2%></span>
										<a href="${renderAction1}&<portlet:namespace />calendarBookingId=<%=calendarBookingId2%>"><h4><%=titleEvent2%></h4></a>
									
								<p><span class="location location-link">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 54.757 54.757" style="margin-right: 2%;enable-background:new 0 0 54.757 54.757;" xml:space="preserve" width="16px" height="16px" class=""><g><path d="M40.94,5.617C37.318,1.995,32.502,0,27.38,0c-5.123,0-9.938,1.995-13.56,5.617c-6.703,6.702-7.536,19.312-1.804,26.952  L27.38,54.757L42.721,32.6C48.476,24.929,47.643,12.319,40.94,5.617z M27.557,26c-3.859,0-7-3.141-7-7s3.141-7,7-7s7,3.141,7,7  S31.416,26,27.557,26z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#929292"></path></g> </svg>
								<a onclick="openQuestioneer(<%=href2%>)"><%=location2%></a></span></p>
								
								<p class="event2-description"><%=descriptionEvent2%></p>
							</div>
				...
				<div class="row" id="event-rw">
					<div class="col-xl-6 col-12 col-md-12 col-lg-6 m-ipad">
						<div class="eventt">
							<div class="evnt-img">
								<img src=<%=img3%> style="height: 223px;">
							</div>
							<div class="evnt-txt">
								<span class="date-tym"><%=mYear3%>-<%=mMonthF3%>-<%=mDayFS3%> <%=hrF3%>:<%=minF3%></span>
										<a href="${renderAction1}&<portlet:namespace />calendarBookingId=<%=calendarBookingId3%>"><h4><%=titleEvent3%></h4></a>
									
								<p><span class="location location-link"><svg version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 54.757 54.757" style="margin-right: 2%;enable-background:new 0 0 54.757 54.757;" xml:space="preserve" width="16px" height="16px" class=""><g><path d="M40.94,5.617C37.318,1.995,32.502,0,27.38,0c-5.123,0-9.938,1.995-13.56,5.617c-6.703,6.702-7.536,19.312-1.804,26.952  L27.38,54.757L42.721,32.6C48.476,24.929,47.643,12.319,40.94,5.617z M27.557,26c-3.859,0-7-3.141-7-7s3.141-7,7-7s7,3.141,7,7  S31.416,26,27.557,26z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#929292"></path></g> </svg>
								<a onclick="openQuestioneer(<%=href3%>)"><%=location3%></a></span></p>
								<p class="event3-description"><%=descriptionEvent3%></p>
							</div>
						</div> 
					</div>
					<div class="col-xl-6 col-12 col-md-12 col-lg-6 m-ipad">
						<div class="eventt">
							<div class="evnt-img">
								<img src=<%=img4%> style="height: 223px;">
							</div>
							<div class="evnt-txt">
								<span class="date-tym"><%=createDateEvnt4%></span>
								<a href="${renderAction1}&<portlet:namespace />calendarBookingId=<%=calendarBookingId4%>"><h4><%=titleEvent4%></h4></a>
									
								<p><span class="location  location-link"><svg version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 54.757 54.757" style="margin-right: 2%;enable-background:new 0 0 54.757 54.757;" xml:space="preserve" width="16px" height="16px" class=""><g><path d="M40.94,5.617C37.318,1.995,32.502,0,27.38,0c-5.123,0-9.938,1.995-13.56,5.617c-6.703,6.702-7.536,19.312-1.804,26.952  L27.38,54.757L42.721,32.6C48.476,24.929,47.643,12.319,40.94,5.617z M27.557,26c-3.859,0-7-3.141-7-7s3.141-7,7-7s7,3.141,7,7  S31.416,26,27.557,26z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#929292"></path></g> </svg>
								<a onclick="openQuestioneer(<%=href4%>)"><%=location4%></a></span></p>
							<p class="event4-description"><%=descriptionEvent4%></p>
							</div>
						</div>
					</div>
				</div>
				<div class="row pb-sm-5">
					<div class="col-xl-12 col-12 col-md-12 text-center mb-3">
						<a href="${renderAction}">Show All Events</a>
					</div>
				</div>
			</div>
		</section>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="row">
                        <div class="col-md-12">                               
                                    <div class="testt">
                                        <p>"It is clear many students want to get involved with this platform and understand the value it provides as they build their profiles and share who they are"</p>
                                        <div class="imgttes">
                                            <img src="/o/new-misk-theme/landingPage/images/test-img.png">
                                            <h4>Muhammad Salam 1<span>HOD Te Reo Maori,<br>Wellington east girls college</span></h4>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="testt">
                                        ...
                                        <div class="imgttes">
                                            <img src="/o/new-misk-theme/landingPage/images/test-img.png">
                                            <h4>Muhammad Salam 2<span>HOD Te Reo Maori,<br>Wellington east girls college</span></h4>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="testt">
                                        ...
                                        <div class="imgttes">
                                            <img src="/o/new-misk-theme/landingPage/images/test-img.png">
                                            <h4>Muhammad Salam 3<span>HOD Te Reo Maori,<br>Wellington east girls college</span></h4>
				...
				<div class="row">
					<div class="col-xl-4 col-12 col-md-4">
						<div class="news-boxes">
							<img src="/o/new-misk-theme/landingPage/images/news-1.png">
							<p>08 Feb 2019</p>
							<h4>Accelerator youth training programme launches at The Warehouse</h4>
							<a href="#"><i class="fa fa-arrow-right"></i></a>
						</div>
					</div>
					<div class="col-xl-4 col-12 col-md-4">
						<div class="news-boxes">
							<img src="/o/new-misk-theme/landingPage/images/news-2.png">
							<p>24 Aug 2018</p>
							<h4>New partnership to provide social record platform for young people</h4>
							<a href="#"><i class="fa fa-arrow-right"></i></a>
						</div>
					</div>
					<div class="col-xl-4 col-12 col-md-4">
						<div class="news-boxes">
							<img src="/o/new-misk-theme/landingPage/images/news-3.png">
							<p>28 Nov 2018</p>
							<h4>Kiwi Social Network Embraced by Youth</h4>
							<a href="#"><i class="fa fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-5 col-md-12 col-12 textcnter">
						<h3>Become Future ready Right here. Right now.</h3>
						<p>Start on the path to your best future, join Youth Hub Today.</p>
					</div>
					<div class="col-xl-7 col-lg-7 col-md-12 col-12">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <select class="form-control selectrole" id="role" name="role">
                                ...
                                <option value=""  disabled="disabled">Manager</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group">                          
                            <input type="text" class="cutomtextbox" id="firstname" name="firstname" placeholder="Firt Name" autocomplete="nope"  disabled="disabled"/>
                        </div>
                        <div class="col-md-6 form-group">                          
                            <input type="text" class="cutomtextbox" id="lastname" name="lastname" placeholder="Last Name" autocomplete="nope"  disabled="disabled"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 form-group">                     
                            <input type="email" class="cutomtextbox" id="email" name="email" placeholder="Email"  autocomplete="nope"  disabled="disabled"/>
                        </div>
                    </div>
                    <div class="row py-2">
                        <div class="col-md-12">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                            <a href="/web/guest/home?p_p_id=com_liferay_login_web_portlet_LoginPortlet&p_p_lifecycle=0&p_p_state=maximized&p_p_mode=view&saveLastPath=false&_com_liferay_login_web_portlet_LoginPortlet_mvcRenderCommandName=%2Flogin%2Flogin" class="btn btn-singin">Sign In</a> 
                            
                            <a href="/web/guest/home?p_p_id=com_liferay_login_web_portlet_LoginPortlet&p_p_lifecycle=0&p_p_state=maximized&p_p_mode=view&saveLastPath=false&_com_liferay_login_web_portlet_LoginPortlet_mvcRenderCommandName=%2Flogin%2Fcreate_account" class="btn btn-singin">Sign Up</a>
                        </div>
                    </div>                  
