...
<!-- 			custom code for field order start -->
			<div class="row">
				<div style="display:block" class="<%= allDay ? "allday-class-active col-md-6 p-1" : "col-md-6 p-1" %>" id="<portlet:namespace />startDateContainer">
					<aui:input ignoreRequestValue="<%= true %>" label="starts" name="startTime" timeFormat="<%= timeFormat %>" value="<%= startTimeJCalendar %>" />
				</div>
	
				<div style="display:block" class="<%= allDay ? "allday-class-active col-md-6 p-1" : "col-md-6 p-1" %>" id="<portlet:namespace />endDateContainer">
...
<!-- 			custom code for field order start -->
					...
					<aui:select name="Speaker form" cssClass="form-idSpeaker" onChange="changeformSpeaker(this)">
					   <% 
					   for (DDMFormInstance ddmFormInstance : formNameList) {
						   if(ddmFormInstance.getUserId() == themeDisplay.getUserId()){
						   		String name = ddmFormInstance.getName(Locale.US);
...
function changeformSpeaker()
{
	console.log($(".form-control.form-idSpeaker").val());
	$("input[name$=_ExpandoAttribute--FormIdSpeaker--]").val($(".form-control.form-idSpeaker").val());
	console.log($("input[name$=_ExpandoAttribute--FormIdSpeaker--]").val());
// 	$("input[name$='_ExpandoAttribute--FormId--']").val($(".Form-id").val());
}
...
{
	$(".lfr-form-content").attr('class','lfr-form-content edit-calendar')
	
	    $("label[for$='___FormIdSpeaker']").css("display","none");
	    $("input[name$='ExpandoAttribute--FormIdSpeaker--']").css("display","none");
	    
	    /*picth start*/
	    $("span[id$='___RegistrationDeadline'] span[id$='___displayDate']").css("display","inline-table");
	    $("span[id$='___RegistrationDeadline'] span[id$='___displayDate']").css("width","25%");
	    $("span[id$='___RegistrationDeadline'] span[id$='___displayDate'] input").css("border-color","#28a745");
	    $("span[id$='___RegistrationDeadline'] span[id$='___displayDate'] input:focus").css("box-shadow","0 0 0 0.2rem rgba(40, 167, 69, 0.25)");
	    $("span[id$='___RegistrationDeadline'] span[id$='___displayTime']").css("display","inline-table");
	    $("span[id$='___RegistrationDeadline'] span[id$='___displayTime']").css("width","25%");
	    $("span[id$='___RegistrationDeadline'] span[id$='___displayTime'] input").css("border-color","#28a745");
	    $("span[id$='___RegistrationDeadline'] span[id$='___displayTime'] input:focus").css("box-shadow","0 0 0 0.2rem rgba(40, 167, 69, 0.25)");
	    $("label[for$='___RegistrationDeadline']").text("Registration Deadline");
	    /*deadline end*/
	    $("label[for$='_form']").text("Main Form");
	    $("label[for$='_Speaker-form']").text("Speaker Questionaire");
	    
	     $("label[for$='___UploadImageId']").css("display","none");
	     $("label[for$='___FormId']").css("display","none");
	     $("label[for$='_calendarId']").css("display","none");
	     $("label[for$='___FormId']").css("display","none");
	      $("select[name$='_calendarId']").css("display","none");
	     $("textarea[id$='___UploadImageId']").css("display","none");
	    ...
	    */  
		...
		if($("input[name$='_ExpandoAttribute--FormIdSpeaker--']").val() == "")
			changeformSpeaker();
		else
		{
			$(".form-idSpeaker").val($("input[name$='_ExpandoAttribute--FormIdSpeaker--']").val());
		}
